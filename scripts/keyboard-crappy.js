...
let keyboardController = {
    ...
    push() {
        ...
        // alert(this.pressed);
        // if (this.pressed.has('KeyZ') && this.pressed.has('KeyX')) {
        //     alert('ass')
        // }

        keyboardController.keyCode = event.code;
        this.pushed = document.querySelector('.' + this.keyCode);

        alert(this.keyCode);
        alert(keyboardController.keyCode);

        if (this.keyCode == 'CapsLock' && this.pushed.className.includes('active')) {
            this.pushed.classList.remove('active');
            changeLayout(engLayoutLowerCase);
        } else if (event.code == 'CapsLock') {
            this.pushed.classList.add('active');
    ...
    release() {
        // this.pressed.remove(event.code);
